...
class TestOrderPage:
    ...
    @pytest.mark.parametrize("name, last_name, address, metro, phone, date, rental_day, color, comment_for_courier",
        [
            ...
            (OrderData.name_2, OrderData.last_name_2, OrderData.address_2, OrderPageLocators.METRO_SPORTIVNAY, OrderData.phone_2, OrderData.date_2, OrderPageLocators.RENT_2_DAYS, OrderPageLocators.CHECKBOX_GREY_COLOR, OrderData.comment_for_courier_1)
